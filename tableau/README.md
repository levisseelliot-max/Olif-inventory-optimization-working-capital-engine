# 📊 Inventory Optimization — Tableau Dashboard

### Dynamic Reorder Engine · ABC/XYZ Analysis · Working Capital Simulator

Interactive Tableau dashboard designed to monitor inventory health, prioritize replenishment decisions, and simulate working-capital release through lead-time reduction.
...
|---|---|
| Executive inventory monitoring | **Tab 1** |
| Procurement & replenishment prioritization | **Tab 2** |
| Lead-time & working-capital simulation | **Tab 3** |

---

<p align="center">
  <strong>📦 Inventory Optimization · 💰 Working Capital · 📊 Supply Chain Analytics</strong>
</p>
