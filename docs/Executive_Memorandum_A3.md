...
1. **CFO Approval** — Authorize Tranche 1 procurement disbursement of **$311,932**.
2. **COO Mandate** — Launch Tier-1 supplier negotiations targeting **50% lead-time compression**.
3. **Operations Review** — Institutionalize **bi-weekly** reviews using the Operational Reorder Engine.

> **North Star:** Release trapped working capital while protecting service levels and eliminating revenue-threatening stockouts.
